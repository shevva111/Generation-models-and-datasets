Code for generation of sythetic tabular datasets and csv files representing each models output used for my master thesis titled, "Privacy Evaluation of Tabular Synthetic Data Generation usingLarge Language Models".
